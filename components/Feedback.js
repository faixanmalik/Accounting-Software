...
function Feedback() {
  ...
  <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
      <iframe width="100%" height="100%" className="absolute inset-0" frameBorder="0" title="map" marginHeight="0" marginWidth="0" scrolling="no" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=%C4%B0AK+(My%20Business%20Name)&ie=UTF8&t=&z=14&iwloc=B&output=embed" style={{filter: 'contrast(1.2)',filter: 'opacity(0.6)' }} />
      <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
        ...
        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
            <div>
                ...
                <a className="text-indigo-500 leading-relaxed">faixan.malik554@gmail.com</a>
                <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                <p className="leading-relaxed">0312-7485454</p>
            </div>  
        </div>
      </div>
    </div>
    <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
      ...
      <p className="leading-relaxed text-gray-600">Please Give your Feedback!</p>
      <p className="leading-relaxed mb-5 text-gray-600">Our Team will assit you as soon as possible.</p>
