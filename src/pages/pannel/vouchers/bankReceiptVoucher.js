...
const BankReceiptVoucher = ({ dbVouchers, dbContacts }) => {
  ...
  const data = { receivedIn, cashInHand, receivedFrom, amount, date, refNo, details, balance, type:'BRV' };
  ...
  const editEntry = async(id)=>{
    ...
    const data = { id, transactionType, igpDate, deliveryChallanNo, venderName,  poNumber, poDate, VehicleNo, driverName, remarks, item, poQty, receivedQty ,  editPath: 'bankReceiptVoucher'};
